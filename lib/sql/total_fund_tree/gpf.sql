...
SELECT DISTINCT * 
FROM Hierarchy   
WHERE SCD_SEC_ID NOT IN (''EHAYFING'',''ECOMPASS'',''EBRONCO'', ''EPIMCO'',''EISOCHRON'',''ENIKE2'',''EISOEOS'',''EISOEOSC'',''EISOEOSB'',''EISOEOSB1'',''EISOMEN'',''EISODEP'') AND SCD_SEC_ID NOT IN (select LOWEST_LEVEL_PORTFOLIO From Hierarchy)
