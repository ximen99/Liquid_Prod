...
FROM rpt_SCD.[Master_FN_POSITION] POS1
      ...
      --                  AND 
                        ...
                        AND INSTRUMENT_TYPE_CODE NOT IN ('ALM', 'CASH', 'FX_FWD','FX_SWP','FX_SPOT','MMKT_POOL_FUND','EQY_POOL_FUND','EQY_IDX_SWP','EQY_SINGLE_NAME_SWP','TERM_DEPOSIT','FF_SWP')
...
SELECT DISTINCT * 
FROM Hierarchy   
WHERE SCD_SEC_ID NOT IN ('EHAYFING','ECOMPASS','EBRONCO', 'EPIMCO','EISOCHRON','ENIKE2','EISOEOS','EISOEOSC','EISOEOSB','EISOEOSB1','EISOMEN','EISODEP','EGUIDEHOUSE') AND SCD_SEC_ID NOT IN (select LOWEST_LEVEL_PORTFOLIO From Hierarchy)
