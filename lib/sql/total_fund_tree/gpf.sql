...
FROM rpt_SCD.[Master_FN_POSITION] POS1
      ...
      --                  AND 
                        ...
                        AND INSTRUMENT_TYPE_CODE NOT IN ('ALM', 'CASH', 'FX_FWD','FX_SWP','MMKT_POOL_FUND','EQY_POOL_FUND','EQY_IDX_SWP','EQY_SINGLE_NAME_SWP', 'FX_SPOT','TERM_DEPOSIT','FF_SWP')
...
SELECT DISTINCT * 
FROM Hierarchy   
WHERE SCD_SEC_ID NOT IN ('EHAYFING','ECOMPASS','EBRONCO', 'EPIMCO','EISOCHRON','ENIKE2','EISOEOS','EISOEOSC','EISOEOSB','EISOEOSB1','EISOMEN','EISODEP','EISOBOR','EGUIDEHOUSE
') AND SCD_SEC_ID NOT IN (select LOWEST_LEVEL_PORTFOLIO From Hierarchy)
